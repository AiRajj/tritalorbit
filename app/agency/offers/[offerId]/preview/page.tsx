    ...
    <main className="min-h-screen bg-[#F8FAFC] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#E63946]">Offer preview</p>
            <h1 className="mt-2 text-4xl font-black tracking-[-0.04em] text-[#0B3C5D]">Candidate-ready assignment offer</h1>
          </div>
          <Button asChild variant="outline">
            <Link href="/agency">Back to agency dashboard</Link>
          </Button>
        </div>
        <OfferPreview offerId={offerId} />
      </div>
    </main>
  );
}
