...
export function getStatusColor(status: string): string {
  switch (status) {
    ...
    case 'VIEWED': return 'text-purple-600 bg-purple-50 border-purple-200'
    ...
    case 'BACKOUT': return 'text-red-700 bg-red-50 border-red-300'
    ...
    case 'WAITING_CANDIDATE': return 'text-purple-600 bg-purple-50 border-purple-200'
